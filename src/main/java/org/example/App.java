...
//  - Грузоподъемность должна равняться весу груза,
//      округленного вверх до числа кратного 500.
//  - Скорость должна равняться скорости, необходимой для прибытия в срок,
//      округленной вверх до ближайшего десятка.
...
// Добавляем все вихикл в ЭррейЛист и затем ищем минимум
        ...
        Transport transport = transportFactory.getTransport(city2, 155, 1);
